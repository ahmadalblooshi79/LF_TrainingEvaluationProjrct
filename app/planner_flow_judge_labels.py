...
_ASSIGNEE_TO_UNIT_LABEL: dict[str, str] = {
    ...
    'محكم الاشارة': 'سرية الإشارة',
    'محكم الإشارة': 'سرية الإشارة',
    ...
    'محكم الأمن': 'قسم الأمن',
    'محكم قسم الأمن': 'قسم الأمن',
    'محكم التزويد والنقل': 'سرية التزويد والنقل',
    'محكم الحرب الإلكترونية': 'سرية الحرب الإلكترونية',
    'محكم كتيبة الاسناد الإداري': 'كتيبة الإسناد الإداري',
    'محكم كتيبة الإسناد الإداري': 'كتيبة الإسناد الإداري',
    ...
    'محكم السرية/2 من كتيبة المشاة الآلية/13': 'كتيبة المشاة الآلية/13 - السرية/2',
    'محكم السرية/3 من كتيبة المشاة الآلية/13': 'كتيبة المشاة الآلية/13 - السرية/3',
    ...
    'محكم السرية/1 من كتيبة/13': 'كتيبة المشاة الآلية/13 - السرية/1',
    'محكم السرية/2 من كتيبة/13': 'كتيبة المشاة الآلية/13 - السرية/2',
    'محكم السرية/3 من كتيبة/13': 'كتيبة المشاة الآلية/13 - السرية/3',
    'محكم السرية/1 من كتيبة/14': 'كتيبة الدبابات/14 - السرية/1',
    'محكم السرية/2 من كتيبة/14': 'كتيبة الدبابات/14 - السرية/2',
    'محكم السرية/3 من كتيبة/14': 'كتيبة الدبابات/14 - السرية/3',
...
_COMPANY_UNIT_PREFIX = {
    ...
    "13": "كتيبة المشاة الآلية/13 - السرية",
    "14": "كتيبة الدبابات/14 - السرية",
}
...
def unit_key_for_assignee_label(assignee_label: str, *, db: Session) -> str:
    ...
    if key:
        return key
    # جسر: تسميات قديمة مختصرة (/3، /4) → دلالة الكشف الرسمية (/13، /14)
...
def _bridge_designation_label_to_catalog(label: str) -> str:
    """تحويل تسميات قديمة/مختصرة إلى دلالة الكشف الرسمية عند الحاجة."""
    s = (label or "").strip()
    if not s:
        return ""
    replacements = (
        ("كتيبة المشاة الآلية/3 - السرية/", "كتيبة المشاة الآلية/13 - السرية/"),
        ("كتيبة الدبابات/4 - السرية/", "كتيبة الدبابات/14 - السرية/"),
        ("كتيبة المشاة الراجلة/11- السرية/", "كتيبة المشاة الراجلة/11 - السرية/"),
        ("كتيبة الاسناد الإداري", "كتيبة الإسناد الإداري"),
        ("سرية الاشارة", "سرية الإشارة"),
    )
    for a, b in replacements:
        if s.startswith(a) or s == a:
            return b + s[len(a) :] if s.startswith(a) and len(s) > len(a) else b
    return s
