"""هيكل مبدئي لمزود llama.cpp (مرحلة لاحقة)."""
...
class LlamaCppProvider(BaseAIProvider):
    ...
    def __init__(self, *, base_url: str = "http://127.0.0.1:8080", timeout: float = 300.0, retry_count: int = 2):
        super().__init__(base_url=base_url or "http://127.0.0.1:8080", timeout=timeout, retry_count=retry_count)
