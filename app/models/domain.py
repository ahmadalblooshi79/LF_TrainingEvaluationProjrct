...
class Exercise(Base):
    ...
    exercise_purpose: Mapped[str] = mapped_column(Text(), default="")
    exercise_type_level_text: Mapped[str] = mapped_column(Text(), default="")
    exercise_participants: Mapped[str] = mapped_column(Text(), default="")
    ...
    program_image_relpath: Mapped[str] = mapped_column(String(500), default="")
    map_text: Mapped[str] = mapped_column(Text(), default="")
    map_image_relpath: Mapped[str] = mapped_column(String(500), default="")
